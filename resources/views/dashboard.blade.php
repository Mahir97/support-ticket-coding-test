    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="text-left">Ticket Reply</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($tickets as $ticket)
                                <tr>
                                    ...
                                    <td class="px-46 py-4 whitespace-nowrap">{{(($ticket->ticket_reply) ?? 'Pending')}}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                <div>
                    <button class="p-6" type = 'button' onclick="window.location='{{ route("auth.ticket") }}'">
                        Create Ticket
                    </button>
                </div>
            </div>
