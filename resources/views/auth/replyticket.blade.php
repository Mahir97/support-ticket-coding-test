<x-guest-layout>
    <form method="POST">
        ...
        <div class="mt-4">
            ...
            <textarea id="ticket_reply" class="block mt-1 w-full" type="text" name="ticket_description" :value="old('ticket_reply')" required> </textarea>
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="ms-4" action="">
                {{ __('Submit') }}
            </x-primary-button>
        </div>
    </form>
